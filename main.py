...
if __name__ == '__main__':
  while True:
    ...
    if choice == 'new game':
      ...
      the_player = class_map[slow_input('Player class [(f)ighter or (m)age]: ', shorthand_map=class_shorthand_map, allowable_inputs=allowable_classes)](the_labyrinth.start_location)
      break
    elif choice == 'load':
